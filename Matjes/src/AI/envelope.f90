...
integer, intent(inout) :: vertex(:),iwk(:)
integer, intent(out) :: nvert

!       Local variables
integer, allocatable :: next(:)
integer      :: i, i1, i2, j, jp1, jp2, i2save, i3, i2next
real(kind=8) :: xmax, xmin, ymax, ymin, dist, dmax, dmin, x1, y1, dx, dy, x2, y2,dx1, dx2, dmax1, dmax2, dy1, dy2, temp, zero
