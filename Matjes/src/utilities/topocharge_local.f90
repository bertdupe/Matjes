...
! internal
       ...
       do j=-1,1,2
        ...
        v=v+(cross(Spin(4:6,i_x,i_y,1,1),Spin(:,ipu,i_y,1,1))*masque(ipu,i_y,1,1)+ &
         cross(Spin(4:6,ipu,i_y,1,1),Spin(4:6,ipu,ipv,1,1))*masque(ipu,i_y,1,1)*masque(ipu,ipv,1,1)+ &
         cross(Spin(4:6,ipu,ipv,1,1),Spin(4:6,i_x,ipv,1,1))*masque(i_x,ipv,1,1)*masque(ipu,ipv,1,1)+ &
         cross(Spin(4:6,i_x,ipv,1,1),Spin(4:6,i_x,i_y,1,1))*masque(i_x,ipv,1,1))*dble(i*j)
