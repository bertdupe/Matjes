...
real(kind=8), allocatable :: exch_local_sym(:),exch_local_antisym(:),ham_DMI_local(:,:,:)
! magnetization
...
if (neighbor_exch_antisym.ne.0) then
  ...
  do i=1,neighbor_exch_antisym
    ham_DMI_local(2,1,i)=-exch_local_antisym(i)*exchange%c_ham
    ham_DMI_local(3,1,i)=exch_local_antisym(i)*exchange%c_ham
    ham_DMI_local(3,2,i)=-exch_local_antisym(i)*exchange%c_ham
