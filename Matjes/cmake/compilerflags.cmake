...
if (${CMAKE_Fortran_COMPILER_ID} MATCHES "Intel")
	...
	set(AFM_flags ${AFM_flags}  __COMPILER__=1)
...
elseif(${CMAKE_Fortran_COMPILER_ID} MATCHES "XL")
   ...
   set(CPP_flags ${CPP_flags}  __COMPILER__=3)
...
elseif(${CMAKE_Fortran_COMPILER_ID} MATCHES "GNU")
   ...
   set(CPP_flags ${CPP_flags}  __COMPILER__=2)
   ...
   set(CMAKE_Fortran_FLAGS_RELEASE "${CMAKE_Fortran_FLAGS_RELEASE} -O4")
	if(${COMPOP} STREQUAL "check")
		set(CMAKE_Fortran_FLAGS_DEBUG "${CMAKE_Fortran_FLAGS_DEBUG} -O0 -g -fcheck=all -Wall -fbacktrace -ffree-form ")
	elseif(${COMPOP} STREQUAL "debug")
		set(CMAKE_Fortran_FLAGS_DEBUG "${CMAKE_Fortran_FLAGS_DEBUG}  -Og -g -lprofiler -fcheck=all -Wall -fbacktrace -ffpe-trap=invalid,overflow,zero,underflow,denormal ")
