...
!internal
      ...
      surface=norm(cross(net(1,:),net(2,:),1,3))
      map_toto=0.0d0
      map_vort=0.0d0
...
! Calcul de la vorticite
       ...
       map_vort(:,i_x,i_y)=cross(Spin(:,i_x,i_y,1),Spin(:,ipu,i_y,1),1,3)+ &
        cross(Spin(:,ipu,i_y,1),Spin(:,ipu,ipv,1),1,3)+ &
        cross(Spin(:,ipu,ipv,1),Spin(:,i_x,ipv,1),1,3)+ &
        cross(Spin(:,i_x,ipv,1),Spin(:,i_x,i_y,1),1,3)
...
! Calcul de la vorticite
       ...
       map_vort(:,i_x,i_y)=cross(Spin(4:6,i_x,i_y,1),Spin(4:6,ipu,i_y,1),1,3)+ &
        cross(Spin(4:6,ipu,i_y,1),Spin(4:6,ipu,ipv,1),1,3)+ &
        cross(Spin(4:6,ipu,ipv,1),Spin(4:6,i_x,ipv,1),1,3)+ &
        cross(Spin(4:6,i_x,ipv,1),Spin(4:6,i_x,i_y,1),1,3)
