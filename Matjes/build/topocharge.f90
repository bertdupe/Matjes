...
!$OMP parallel private(i,j) default(shared)
       ...
       map_vort_int(:,i,j)=cross(Spins(:,i,j),Spins(:,ipu,j),1,3)+ &
       cross(Spins(:,ipu,j),Spins(:,ipu,ipv),1,3)+cross(Spins(:,ipu,ipv),Spins(:,i,ipv),1,3)+ &
       cross(Spins(:,i,ipv),Spins(:,i,j),1,3)
...
!$OMP parallel private(i_x,i_y,i_m,ipm) default(shared)
      ...
      do i_m=1,shape_spin(5)
       do i_y=Ystart,Ystop
        ...
        map_vort_int(:,i_x,i_y)=map_vort_int(:,i_x,i_y)+cross(Spins(:,i_x,i_y,i_m),Spins(:,ipu,i_y,i_m),1,3)+ &
         cross(Spins(:,ipu,i_y,i_m),Spins(:,ipu,ipv,i_m),1,3)+cross(Spins(:,ipu,ipv,i_m),Spins(:,i_x,ipv,i_m),1,3)+ &
         cross(Spins(:,i_x,ipv,i_m),Spins(:,i_x,i_y,i_m),1,3)
...
!$OMP parallel do default(shared)
       ...
       do i=Xstart,Xstop
        ...
        map_vort_int(:,i)=cross(Spins(:,i),Spins(:,ipu),1,3)
