...
! ===============================================================
!
      SUBROUTINE MCstep(E_total,E,Magnetization,kt,acc,rate,nb,cone, &
...
!---------------------------------------
      ...
      if (sphere) then
        S_new=sphereft(Spin(4:6,Ilat(1),Ilat(2),Ilat(3),Ilat(4)),cone)
!---------------------------------------
! Algorithm square sampling
!---------------------------------------
      elseif (equi) then
        S_new=equirep(Spin(4:6,Ilat(1),Ilat(2),Ilat(3),Ilat(4)),cone)
      endif
!---------------------------------
