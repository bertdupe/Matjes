      subroutine spindynamics(spin,shape_spin,tableNN,shape_tableNN,masque,shape_masque,indexNN,shape_index, &
    &   N_cell,mag_lattice, &
...
#endif
      call rw_dyna(shape_spin(2:4),mag_lattice)
...
!$OMP end parallel do
     ...
     &   storque, torque_FL, kT/k_B,(security(i),i=1,2),H_int
      ...
      if ((Ffield).and.(mod(j-1,gra_freq).eq.0)) call field_sd(j/gra_freq,spin,shape_spin)
