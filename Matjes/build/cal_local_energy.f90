      ...
      function loc_en_MC(i_DM,i_four,i_biq,i_dip,i_stone,EA,Ilat, &
...
! internal
      ...
      E_int(3)=anisotropy(i_x,i_y,i_z,i_m,EA,spin,shape_spin)
      if (i_DM) E_int(5)=2.0d0*DMenergy(i_x,i_y,i_z,i_m,spin,shape_spin,tableNN,masque,indexNN)
      if (i_four) E_int(4)=4.0d0*fourspin(i_x,i_y,i_z,i_m,spin,shape_spin,masque,Periodic_log)
      ...
      subroutine local_energy_decompose(E_int,i_DM,i_four,i_biq,i_dip,EA,i_x,i_y,i_z,i_m, &
          & spin,shape_spin,tableNN,shape_tableNN,masque,shape_masque,indexNN,shape_index,h_ext, &
          & my_lattice)
      use m_energy
      implicit none
...
! internal
      ...
      if (i_four) E_int(4)=fourspin(i_x,i_y,i_z,i_m,spin,shape_spin,masque,Periodic_log)
      ...
      subroutine local_energy_av(E_int,i_DM,i_four,i_biq,i_dip,EA,i_x,i_y,i_z,i_m, &
          & spin,shape_spin,tableNN,shape_tableNN,masque,shape_masque,indexNN,shape_index,h_ext, &
          & my_lattice)
      use m_energy
      implicit none
...
! internal
      ...
      E_int=E_int+anisotropy(i_x,i_y,i_z,i_m,EA,spin,shape_spin)
      if (i_DM) E_int=E_int+DMenergy(i_x,i_y,i_z,i_m,spin,shape_spin,tableNN,masque,indexNN)
      if (i_four) E_int=E_int+fourspin(i_x,i_y,i_z,i_m,spin,shape_spin,masque,Periodic_log)
