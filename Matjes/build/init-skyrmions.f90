...
subroutine init_Sk(io,fname,my_lattice,my_motif)
use m_vector
use m_io_utils
...
call get_parameter(io,fname,'NSkyAdd',NSkyAdd)
call get_parameter(io,fname,'N_pinning',N_pinning)
...
subroutine get_skyrmion(x0,y0,R0,coeffx,coeffy,starx,stary,chirality,my_lattice,my_motif)
