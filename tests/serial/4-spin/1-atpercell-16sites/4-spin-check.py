...
while counter < Nmax:
    ...
    M1 = np.array( [s*math.sqrt(3.0)/2.0  , s/2.0                  ,c ] )
    M2 = np.array( [s*0.5                 ,-s*math.sqrt(3.0)/2.0   ,c ] )
    M3 = np.array( [-s*0.5                , s*math.sqrt(3.0)/2.0   ,c ] )
    M4 = np.array( [-s*math.sqrt(3.0)/2.0 ,-s/2.0                  ,c ] )
