...
private
public pair_dat_t, get_pair_dat
...
type    :: pair_dat_t
    ...
    integer,allocatable     :: ind_mag(:)       !(Nat) indices of atoms in magnetic basis (is this necessary?, general atom indices whight be better)
...
subroutine get_pair_dat(lat,at_type,neigh_in,pair_dat)
