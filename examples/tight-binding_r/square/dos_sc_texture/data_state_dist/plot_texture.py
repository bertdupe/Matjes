...
def plot_states(i_dat,pos,E,dos,extema,shape,extent):
    ...
    axs[0].text(s="spin up", transform=axs[0].transAxes,**text_args)
    axs[1].text(s="spin down", transform=axs[1].transAxes,**text_args)
